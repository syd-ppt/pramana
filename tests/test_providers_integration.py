...
class TestClaudeCodeProvider:
    ...
    async def test_sdk_error_after_response_returns_captured(self):
        ...
        async def mock_streaming():
            ...
            msg.content = [block]
            yield msg
            raise ClaudeSDKError("Unknown event type: rate_limit_event")
    ...
    async def test_sdk_error_before_response_raises(self):
        ...
        with patch("claude_agent_sdk.query", return_value=error_immediately()):
    ...
    async def test_generic_exception_raises_runtime_error(self):
        ...
        with patch("claude_agent_sdk.query", return_value=network_error()):
    ...
    async def test_no_response_raises(self):
        ...
        with patch("claude_agent_sdk.query", return_value=empty_stream()):
